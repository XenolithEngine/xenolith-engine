...
SPRT_CONST(_CRTDBG_ALLOC_MEM_DF);
SPRT_CONST(_CRTDBG_DELAY_FREE_MEM_DF);
SPRT_CONST(_CRTDBG_CHECK_ALWAYS_DF);
SPRT_CONST(_CRTDBG_RESERVED_DF);
SPRT_CONST(_CRTDBG_CHECK_CRT_DF);
SPRT_CONST(_CRTDBG_LEAK_CHECK_DF);
SPRT_CONST(_CRTDBG_REPORT_FLAG);
