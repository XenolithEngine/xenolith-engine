...
// Embox Unicode backend for the sprt runtime.
//
...
//   * toupper/tolower/totitle fold ASCII via Embox libc towupper/towlower
...
// Embox libc towupper/towlower operate on the C/POSIX locale, which folds
...
char32_t totitle(char32_t c) {
	// Embox libc has no towtitle; titlecase folds to upper for the ASCII range,
...
// C locale the Embox flat build ships; locale-aware collation needs ICU and
...
// --- IDN ---------------------------------------------------------------------
// No ICU/libidn2 on Embox flat build; IDN conversion is unavailable. Callers
