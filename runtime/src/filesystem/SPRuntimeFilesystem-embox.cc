...
// Embox filesystem path layout — minimal port of SPRuntimeFilesystem-wasm.cc.
//
// The qemu-armv8a Embox flat build has no XDG, no /home, no /usr/share. The
...
void _initSystemPaths(LookupData &data) {
	...
	// %PLATFORM% — the read-only app bundle. On Embox there is no installer
