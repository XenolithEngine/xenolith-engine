...
enum {
	...
	AMETA_META_ON = 0x1'0000,

	/** This mask is used to check whether the left META meta key is pressed. */
	AMETA_META_LEFT_ON = 0x2'0000,

	/** This mask is used to check whether the right META meta key is pressed. */
	AMETA_META_RIGHT_ON = 0x4'0000,

	/** This mask is used to check whether the CAPS LOCK meta key is on. */
	AMETA_CAPS_LOCK_ON = 0x10'0000,

	/** This mask is used to check whether the NUM LOCK meta key is on. */
	AMETA_NUM_LOCK_ON = 0x20'0000,

	/** This mask is used to check whether the SCROLL LOCK meta key is on. */
	AMETA_SCROLL_LOCK_ON = 0x40'0000,
};
...
enum {
	/** mask */
	AINPUT_SOURCE_CLASS_MASK = 0x0000'00ff,

	/** none */
	AINPUT_SOURCE_CLASS_NONE = 0x0000'0000,
	/** button */
	AINPUT_SOURCE_CLASS_BUTTON = 0x0000'0001,
	/** pointer */
	AINPUT_SOURCE_CLASS_POINTER = 0x0000'0002,
	/** navigation */
	AINPUT_SOURCE_CLASS_NAVIGATION = 0x0000'0004,
	/** position */
	AINPUT_SOURCE_CLASS_POSITION = 0x0000'0008,
	/** joystick */
	AINPUT_SOURCE_CLASS_JOYSTICK = 0x0000'0010,
};
...
enum {
	/** unknown */
	AINPUT_SOURCE_UNKNOWN = 0x0000'0000,

	/** keyboard */
	AINPUT_SOURCE_KEYBOARD = 0x0000'0100 | AINPUT_SOURCE_CLASS_BUTTON,
	/** dpad */
	AINPUT_SOURCE_DPAD = 0x0000'0200 | AINPUT_SOURCE_CLASS_BUTTON,
	/** gamepad */
	AINPUT_SOURCE_GAMEPAD = 0x0000'0400 | AINPUT_SOURCE_CLASS_BUTTON,
	/** touchscreen */
	AINPUT_SOURCE_TOUCHSCREEN = 0x0000'1000 | AINPUT_SOURCE_CLASS_POINTER,
	/** mouse */
	AINPUT_SOURCE_MOUSE = 0x0000'2000 | AINPUT_SOURCE_CLASS_POINTER,
	/** stylus */
	AINPUT_SOURCE_STYLUS = 0x0000'4000 | AINPUT_SOURCE_CLASS_POINTER,
	/** bluetooth stylus */
	AINPUT_SOURCE_BLUETOOTH_STYLUS = 0x0000'8000 | AINPUT_SOURCE_STYLUS,
	/** trackball */
	AINPUT_SOURCE_TRACKBALL = 0x0001'0000 | AINPUT_SOURCE_CLASS_NAVIGATION,
	/** mouse relative */
	AINPUT_SOURCE_MOUSE_RELATIVE = 0x0002'0000 | AINPUT_SOURCE_CLASS_NAVIGATION,
	/** touchpad */
	AINPUT_SOURCE_TOUCHPAD = 0x0010'0000 | AINPUT_SOURCE_CLASS_POSITION,
	/** navigation */
	AINPUT_SOURCE_TOUCH_NAVIGATION = 0x0020'0000 | AINPUT_SOURCE_CLASS_NONE,
	/** joystick */
	AINPUT_SOURCE_JOYSTICK = 0x0100'0000 | AINPUT_SOURCE_CLASS_JOYSTICK,
	/** HDMI */
	AINPUT_SOURCE_HDMI = 0x0200'0000 | AINPUT_SOURCE_CLASS_BUTTON,
	/** sensor */
	AINPUT_SOURCE_SENSOR = 0x0400'0000 | AINPUT_SOURCE_CLASS_NONE,
	/** rotary encoder */
	AINPUT_SOURCE_ROTARY_ENCODER = 0x0040'0000 | AINPUT_SOURCE_CLASS_NONE,

	/** any */
	AINPUT_SOURCE_ANY = 0xffff'ff00,
};
...
float AMotionEvent_getHistoricalAxisValue(const AInputEvent *motion_event, int32_t axis,
		size_t pointer_index, size_t history_index);
