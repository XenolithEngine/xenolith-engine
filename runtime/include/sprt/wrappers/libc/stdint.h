...
#define INTMAX_C(V) __SPRT_INTMAX_C(V)
#define UINTMAX_C(V) __SPRT_UINTMAX_C(V)
...
#define INT_LEAST8_MIN   (-1-__SPRT_INT_LEAST8_MAX)
#define INT_LEAST16_MIN  (-1-__SPRT_INT_LEAST16_MAX)
#define INT_LEAST32_MIN  (-1-__SPRT_INT_LEAST32_MAX)
#define INT_LEAST64_MIN  (-1-__SPRT_INT_LEAST64_MAX)
#define INT_LEAST8_MAX   __SPRT_INT_LEAST8_MAX
#define INT_LEAST16_MAX  __SPRT_INT_LEAST16_MAX
#define INT_LEAST32_MAX  __SPRT_INT_LEAST32_MAX
#define INT_LEAST64_MAX  __SPRT_INT_LEAST64_MAX
#define UINT_LEAST8_MAX  __SPRT_UINT_LEAST8_MAX
#define UINT_LEAST16_MAX __SPRT_UINT_LEAST16_MAX
#define UINT_LEAST32_MAX __SPRT_UINT_LEAST32_MAX
#define UINT_LEAST64_MAX __SPRT_UINT_LEAST64_MAX

#define INT_FAST8_MIN    (-1-__SPRT_INT_FAST8_MAX)
#define INT_FAST16_MIN   (-1-__SPRT_INT_FAST16_MAX)
#define INT_FAST32_MIN   (-1-__SPRT_INT_FAST32_MAX)
#define INT_FAST64_MIN   (-1-__SPRT_INT_FAST64_MAX)
#define INT_FAST8_MAX    __SPRT_INT_FAST8_MAX
#define INT_FAST16_MAX   __SPRT_INT_FAST16_MAX
#define INT_FAST32_MAX   __SPRT_INT_FAST32_MAX
#define INT_FAST64_MAX   __SPRT_INT_FAST64_MAX
#define UINT_FAST8_MAX   __SPRT_UINT_FAST8_MAX
#define UINT_FAST16_MAX  __SPRT_UINT_FAST16_MAX
#define UINT_FAST32_MAX  __SPRT_UINT_FAST32_MAX
#define UINT_FAST64_MAX  __SPRT_UINT_FAST64_MAX
