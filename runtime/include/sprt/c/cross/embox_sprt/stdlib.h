// Embox libc stdlib.h workarounds.
//
// Embox <stdlib.h> defines several names as macros that the sprt umbrella
...
// survive intact. The Embox libc defines the underlying plain functions
