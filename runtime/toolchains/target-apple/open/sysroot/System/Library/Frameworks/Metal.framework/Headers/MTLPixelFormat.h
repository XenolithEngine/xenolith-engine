 ...
 * Hand-written <Metal/MTLPixelFormat.h> for *-apple-macosx+open. MoltenVK maps the whole
 * Metal format space, so the COMPLETE enum is reconstructed here with SDK-exact values;
 * every entry carries an explicit value so subsetting/reordering can never shift them. */
#ifndef __SPRT_OPEN_METAL_MTLPIXELFORMAT_H_
#define __SPRT_OPEN_METAL_MTLPIXELFORMAT_H_
...
#endif /* __SPRT_OPEN_METAL_MTLPIXELFORMAT_H_ */
